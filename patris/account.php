                ...
                <div class="row">
                    ...
                    <div class="basic-login">
                            ...
                            <form action="" method="POST">
                                ...
                                <input id="pass" name="pass" type="password" placeholder="Enter New Password..." required/>
                                <label for="fullame">Name <span>**</span></label>
                                <input id="fullname" name="fullname" type="text" value="<?php echo $row['customer_name']; ?>" required/>
                                ...
                                <input id="birth" name="birth" type="date" value="<?php echo $row['customer_birth']; ?>" required/>
                                <label for="phone">Phone Number <span>**</span></label>
                                <input id="phone" name="phone" type="text" value="<?php echo $row['customer_telp']; ?>" required/>
                                <div class="mt-10"></div>
