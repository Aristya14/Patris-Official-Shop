        ...
        <div class="container-fluid">
                                ...
                                <ul>
                                    <li>
                                        <a href="indexAdmin.php">
                                            <span style="font-size: 15px; margin-right: 20px;margin-left: 15px;">Home</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a class="active" href="shop.php">
                                            <span style="font-size: 15px;margin-right: 20px;">Product</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="contact.php">
                                            <span style="font-size: 15px;margin-right: 20px;">Contact</span>
                                        </a>
                                    </li>
                                </ul>
                            </nav>
                            ...
                            <ul class="text-right">
                                <li>
                                 ...
                                 " class="account">
                                        ...
                                        <article class="account-registar d-inline-block"> <?php
                                                                                            if (isset($_SESSION['username'])) {
                                                                                                echo $user;
                                                                                            } else {
                                                                                                echo "Login/Sign Up";
                                        ...
                                        <div class="search-popup-inner mt-135">
                                            ...
                                            <div class="search-content pt-55">
                                                <ul class="text-center">
                                                    <li>
                                                        <a href="javascript:void(0)" class="active">All categories</a>
                                                    </li>
                                                    <li>
                                                        <a href="javascript:void(0)">Sepatu</a>
                                                    </li>
                                                    <li>
                                                        <a href="javascript:void(0)">Wedges</a>
                                                    </li>
                                                    <li>
                                                        <a href="javascript:void(0)">Sandal</a>
                                                    </li>
                                                    <li>
                                                        <a href="javascript:void(0)">Sepatu-Sandal</a>
                                                    </li>
                                                </ul>
                                                    ...
                                                    <ul class="text-left">
                                                        <li class="d-block d-flex align-items-center">
                                                            ...
                                                            <div class="search-result-desc pl-10">
                                                                <a href="detailproduct.php" class="title px-0">ELLE - Recliner syntheti chair</a>
                                                                <div class="price">$ <span>399</span>
                                                                </div>
                                                            </div>
                                                        </li>
                                                        <li class="d-block d-flex align-items-center">
                                                            ...
                                                            <div class="search-result-desc pl-10">
                                                                <a href="detailproduct.php" class="title px-0">RIMINI - Folding leather deck chair</a>
                                                                <div class="price">$ <span>399</span>
                                                                </div>
                                                            </div>
                                                        </li>
                                                        <li class="d-block d-flex align-items-center">
                                                            ...
                                                            <div class="search-result-desc pl-10">
                                                                <a href="detailproduct.php" class="title px-0">LANDSCAPE - Folding fabric deck chair</a>
                                                                <div class="price">$ <span>399</span>
                                                                </div>
                                                            </div>
                                                        </li>
                                                ...
                                                <ul class="text-left">
                                                    <li>
                                                        <div class="minicart-img">
                                                            <a href="detailproduct.php" class="p-0">
                                                                <img src="img/product/1.jpg" class="w-100" alt="">
                                                            </a>
                                                        </div>
                                                        <div class="minicart-desc">
                                                            <a href="detailproduct.php" class="p-0">Capitalize on low hanging fruit t</a>
                                                    ...
                                                    <li>
                                                        ...
                                                        <div class="minicart-desc">
                                                            <a href="detailproduct.php" class="p-0">Leather Courriere duffle ba</a>
                                                    ...
                                                    <li>
                                                        ...
                                                        <div class="minicart-desc">
                                                            <a href="detailproduct.php" class="p-0">Party Supplies Around Cupcake</a>
                                                            <strong>1 × $150.00</strong>
                                                        </div>
                                                        <div class="remove">
                                                            <i class="fal fa-times"></i>
            ...
            <div class="mobile-menu visible-sm">
                <div id="mobile-menu">
                    <ul>
                        <li>
                            <a class="pl-3" href="javascript:void(0)" href="indexAdmin.php">Home</a>
                        </li>
                        <li>
                            <a class="pl-3" href="javascript:void(0)" href="shop.php">Product</a>
                        </li>
                        <li>
        ...
        <div class="container-fluid">
            <nav aria-label="breadcrumb" class="mb-40">
                <ol class="breadcrumb p-0 m-0">
                    ...
                    if ($_GET['cat']) {
                        echo
                        '<li class="breadcrumb-item" aria-current="page"><a href="shop.php">Product</a></li>
                        <li class="breadcrumb-item active" aria-current="page"><a href="shop.php?cat='. $cat .'">'.$row2['category_name'].'</a></li>'
                        ;
                    } else {
                        echo
                        '<li class="breadcrumb-item active" aria-current="page"><a href="shop.php">Product</a></li>';
                    }
                    ?>
                </ol>
            </nav>
            <div class="shop-wrapper">
                <div class="row">
                    <div class="col-12">
                            ...
                            <div class="row">
                                <div class="col-xl-4 col-lg-4 col-md-4 col-12">
                                    <div class="filter-shown-item">
                                        <p class="mb-0">Showing 1 - <?php echo $num; ?> of <?php echo $num; ?> results </p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <!-- /. product box -->
                        <!-- <div class="text-center mt-20"><a href="shop.php" class="load-more">LOAD MORE...</a></div> -->
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="col-xl-5 col-lg-5 col-md-9">
                                <div class="footer-item has-desc">
                                    <div class="footer-logo mb-25">
                                        ...
                                        <p style="color: #FFFFFF;font-size: 20px;font-weight: 20px;margin-top: 40px;"> Customer Service</p>
                                        <p style="color: #FFFFFF;font-size: 20px;font-weight: 20px;margin-top: 40px;">Jam Kerja: 09.00 s/d 15.00 WIB</p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-6">
                                        <div class="footer-menu">
                                            <ul>
                                                <li>
                                                    <a href="indexAdmin.php" style="color: #FFFFFF;font-size: 20px;font-weight: 20px;">Home</a>
                                                </li>
                                                <li>
                                                    <a href="account.php" style="color: #FFFFFF;font-size: 20px;font-weight: 20px; margin-top: 30px;">My account</a>
                                                </li>
                                                <li>
                                                    <a href="checkout.php" style="color: #FFFFFF;font-size: 20px;font-weight: 20px;margin-top: 30px;">Checkout</a>
                                                </li>
                                                <li>
                                                    <a href="shop.php" style="color: #FFFFFF;font-size: 20px;font-weight: 20px;margin-top: 30px;">Product</a>
                                                </li>
                                                <li>
                                                    <a href="contact.php" style="color: #FFFFFF; font-size: 20px;font-weight: 20px;margin-top: 30px;">Contact</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 hidden-sm" style="margin-left:100px;">
                                        <div class="footer-menu">
                                            <ul>
                                                <li style="color: #FFFFFF;font-size: 20px;font-weight: 20px;">Follow Us: </li>
                                                <li style="color: #FFFFFF; font-size: 20px;font-weight: 20px;margin-top: 30px;">
                                                    <img src="https://img.icons8.com/material-rounded/50/ffffff/instagram-new.png" /> Patris.Official
                                                </li>
                                                <li style="color: #FFFFFF; font-size: 20px;font-weight: 20px;margin-top: 30px;">
                                                    <img src="https://img.icons8.com/material-rounded/50/ffffff/twitter.png" /> Patris_Shoes </a>
                                                </li>
                                                <li style="color: #FFFFFF; font-size: 20px;font-weight: 20px;margin-top: 30px;">
                                                    <img src="https://img.icons8.com/ios-filled/50/ffffff/facebook--v1.png" /> PATRIS SHOES </a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-7 col-lg-7 col-md-7 col-sm-6">
                            <div class="product-content">
                                ...
                                <div class="price">$ <span>44.00</span>– <span>$250.00</span>
                                </div>
                    ...
                    <div class="col-6 h-100">
                        <div class="startup-popup-inner h-100">
                            ...
                            <div class="startup-popup-main-content">
                                ...
                                <p class="mb-0">Subscribe to the Mazia store mailing list to receive updates on new arrivals, special offers and other discount information.</p>
