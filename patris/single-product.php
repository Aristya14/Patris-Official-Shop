                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-5 col-lg-6 hidden-md position-static">
                        <div class="header-nav">
                            <nav>
                                <ul>
                                    <li><a href="index.php"><span style="font-size: 15px; margin-right: 20px;margin-left: 15px;">Home</span></a>
                                    </li>
                                    <li class="position-static"><a class="active" href="shop.php"><span style="font-size: 15px;margin-right: 20px;">Shop</span></a></li>
        ...
        <div class="container-fluid">
            <nav aria-label="breadcrumb" class="mb-40">
                <ol class="breadcrumb p-0 m-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><a href="shop.php?cat=<?php echo $row['category_id']; ?>"><?php echo $row['category_name']; ?></a></li>
                </ol>
            </nav>
