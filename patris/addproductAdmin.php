                            ...
                            <nav>
                                <ul>
                                    ...
                                    <li class="position-static"><a href="shop.php"><span
                                                style="font-size: 15px;margin-right: 20px;">Product</span></a></li>
            ...
            <div class="mobile-menu visible-sm">
                <div id="mobile-menu">
                    <ul>
                        ...
                        <li><a class="pl-3" href="javascript:void(0)" href="shop.php">Product</a></li>
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="breadcrumb-content" style="flex-direction: column;">
                            ...
                            <h2 class="cart-title mt-40">Product</h2>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-lg-6">
                            <div class="checkbox-form">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="checkout-form-list">
                                            <label>Stock Product <span class="required">*</span></label>
                                            <input type="text" placeholder="" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="your-order-table table-responsive">
                                    <div class="col-md-12">
                                        <div class="checkout-form-list" style="padding-top:70px;">
                                            <label>Price (Rupiah) <span class="required">*</span></label>
                                            <input type="text" placeholder="" />
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-12">
                                        <div class="checkout-form-list">
                                            <label>Weight (Gram) <span class="required">*</span></label>
                                            <input type="text" placeholder="" />
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-6">
                                        <div class="footer-menu">
                                            <ul>
                                                ...
                                                <li><a href="shop.php"
                                                        style="color: #FFFFFF;font-size: 20px;font-weight: 20px;margin-top: 30px;">Product</a>
                                                </li>
