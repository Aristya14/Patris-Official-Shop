        ...
        <div class="container-fluid">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a class="active" href="shop.php">
                                            <span style="font-size: 15px;margin-right: 20px;">Shop</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="contact.php">
                                                ...
                                                <ul class="text-left">
                                                    <li>
                                                        <div class="minicart-img">
                                                            <a href="single-product.php" class="p-0">
                                                                <img src="img/product/1.jpg" class="w-100" alt="">
                                                            </a>
                                                        </div>
            ...
            <div class="mobile-menu visible-sm">
                <div id="mobile-menu">
                    <ul>
                        <li>
                            <a class="pl-3" href="javascript:void(0)" href="index.php">Home</a>
                        </li>
                        <li>
                            <a class="pl-3" href="javascript:void(0)" href="shop.php">Shop</a>
                        </li>
                        <li>
                                ...
                                <div class="row">
                                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-6">
                                        <div class="footer-menu">
                                            <ul>
                                                <li>
                                                    <a href="index.php" style="color: #FFFFFF;font-size: 20px;font-weight: 20px;">Home</a>
                                                </li>
                                                <li>
                                                ...
                                                <li>
                                                    <a href="shop.php" style="color: #FFFFFF;font-size: 20px;font-weight: 20px;margin-top: 30px;">Shop</a>
                                                </li>
                                                <li>
